...
```bash
npm install html-react-parser react-markdown rehype-raw rehype-sanitize remark-gfm --save
```
</TabItem>
<TabItem value="yarn" label="yarn">
```bash
yarn add html-react-parser react-markdown rehype-raw rehype-sanitize remark-gfm
```
</TabItem>
<TabItem value="pnpm" label="pnpm">
```bash
pnpm add html-react-parser react-markdown rehype-raw rehype-sanitize remark-gfm
```
</TabItem>
<TabItem value="bun" label="bun">
```bash
bun add html-react-parser react-markdown rehype-raw rehype-sanitize remark-gfm
```
</TabItem>
</Tabs>
