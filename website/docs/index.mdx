...
**react-text-to-speech** is an easy-to-use React.js component for the [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API). It is as easy as to import a React.js component!
