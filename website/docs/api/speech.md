...
| ---------------------------- | ----------------------------------------------------------------------------- | -------- | ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `text`                       | `ReactNode`                                                                   | Yes      | -                 | It contains the text to be spoken by **Web Speech API**.                                                                                                                                                                                                                          |
...
| `startBtn`                   | `ReactNode`                                                                   | No       | `<HiVolumeUp />`  | Button to start the speech instance.                                                                                                                                                                                                                                              |
| `pauseBtn`                   | `ReactNode`                                                                   | No       | `<HiVolumeOff />` | Button to pause the speech instance.                                                                                                                                                                                                                                              |
| `stopBtn`                    | `ReactNode`                                                                   | No       | `<HiMiniStop />`  | Button to stop the speech instance.                                                                                                                                                                                                                                               |
